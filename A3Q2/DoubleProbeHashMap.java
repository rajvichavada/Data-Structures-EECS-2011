...
public class DoubleProbeHashMap<K, V> extends ProbeHashMap<K, V> {
  ...
  /**
    ...
    protected void resize(int newCap) {
    	...
    	* MLA CITATION OF CODE EXCERPT USED FROM TEXTBOOK AND ProbeHashMap.java
    	 * Tamassia, Roberto, and Michael H Goldwasser. “ 
    	 * 10.2 Hash Tables.” Data Structures And Algorithms, 
    	 * by Michael T Goodrich, 6th ed., Wiley, pp. 410–428.
    	 */
     ...
     * hâ€™(k) = q - k mod q, where the secondary prime factor q is the smallest 
 ...
 * by Michael T Goodrich, 6th ed., Wiley, pp. 410–428.
  ...
  */  	
         ...
         do {
             ...
             h2++;
             j = (j + (h2 * sec)) % capacity;                       // keep looking (cyclically)
         } while (j != h1);                             // stop if we return to the start
         return -(avail + 1);  
    }

    /**
     * Returns value of secondary hash function hâ€™(k) = q - k mod q, 
